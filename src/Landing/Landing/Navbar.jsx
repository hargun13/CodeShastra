...
import logo from '../../Logos/cslogo.png'
...
function Navbar() {
  ...
  return (
    <div className='text-black flex justify-between mx-auto p-5 h-20  items-center '>
        ...
        <a href='/' className='mx-11 w-44 font-bold'><img src={logo} className='h-24' alt="main navbar logo h-12"/></a>
        ...
        <ul className='hidden md:flex font-bold text-base mr-14'>
            <li className='p-2 px-10 transition duration-300 hover:text-white  cursor-pointer'>
                <a href='/Login'>Login</a>
            </li>
            <li className='p-2 px-4 bg-[#FF6600] rounded-3xl transition duration-300 hover:text-white  cursor-pointer'>
                <button >
