...
import hero from './Job hunt-pana.png'
    ...
    <div style={{backgroundImage: `url(${bag2})`, backgroundSize:'cover'}} className="h-screen w-screen overflow-y-hidden flex items-center justify-between px-10" >
        ...
        <div className="h-[90%] w-[40%] rounded-3xl bg-white flex flex-col item-center justify-center shadow-2xl">
            ...
            <div className=" w-full pt-4">
                <a href="/" className="flex justify-center"><img src={logo} className="h-20" alt="straddle logo"/></a>
            </div>
                ...
                <div className="w-[100%] mt-5">
                    ...
                    <div className="mt-8 mb-5" >
                        <Link to="/Profile">
                            ...
                            className="w-full rounded-full" style={{padding:"10px", backgroundColor:"#000000", color:"white"}}>
                                Sign Up
                            </Button>
                        </Link>
                    </div>
