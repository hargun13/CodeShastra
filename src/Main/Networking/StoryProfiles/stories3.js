...
const customCollapsedComponent1 = ({ toggleMore, action }) =>
	<div className='  h-[30vh] pb-16 pl-8 text-white'  draggable onDragStart={(e) => onDragStart(e, stories)}>
		<h1 className='text-3xl font-extrabold'>Rohit Rai</h1>
        <p className='flex items-center my-2 text-sm'> - &nbsp; <MdWorkOutline size={15}/> &nbsp; App Dev at Engaze</p>
...
const stories = [
    {
        url: 'https://images.pexels.com/photos/2589653/pexels-photo-2589653.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
        header: {
			heading: 'Rohit Rai',
