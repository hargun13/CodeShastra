...
const customCollapsedComponent1 = ({ toggleMore, action }) =>
	<div className='  h-[30vh] pb-16 pl-8 text-white'  draggable onDragStart={(e) => onDragStart(e, stories)}>
		<h1 className='text-3xl font-extrabold'>Bhavya Poddar</h1>
        <p className='flex items-center my-2 text-sm'> - &nbsp; <MdWorkOutline size={15}/> &nbsp; Frontend Dev at Google</p>
