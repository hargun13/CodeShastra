...
//icons
import { MdChecklist, MdOutlineDashboard } from "react-icons/md";
  ...
  const [redirectUrl, setRedirectUrl] = useState("");
    ...
    const list = () => {
      ...
      return (
        ...
        >
          <img src={logo} alt="trucomply logo" className='h-20'/>
          <List>
      ...
      <Box display="flex" justifyContent="space-between" p={1}>
            <div className='flex items-center justify-center'>
                <Button onClick={toggleDrawer(true)}>
                    <MenuIcon color='black' style={{color:"black"}}/>
                </Button>
                <Drawer
                    anchor="left"
                    open={isDrawerOpen}
                ...
                <img src={logo} alt="fitzen logo" className='h-8'/>
            </div>
